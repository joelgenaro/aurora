...
export class HistoryOneComponent extends BaseComponent implements OnInit, AfterViewInit {
  @Input() pageFlag: string;
  @Output() nextPageEvent = new EventEmitter();
  // NextPageEvent<string> = new EventEmitter<string>();
  ...
  onTicketEdited(_category: TicketHistoryListItem) {
    ...
    this.pageFlag = 'second_page';
    this.NextPageEvent.emit(this.pageFlag);
    console.log(this.pageFlag, this.NextPageEvent.emit(this.pageFlag))
  }
